    ...
    def decorator(f):
        ...
        def wrapper(*args, **kw):
            ...
            if payload is None:
                ...
                try:
                    jsonschema.validate(payload, json.load(open("schema/" + schema + ".json", "r")), format_checker=jsonschema.FormatChecker())
                    g.payload = payload
...
def response(payload=None, status_code=200, error_code=None, error_message=None, success=None, empty=False):
